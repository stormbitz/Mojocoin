...
static const int LAST_POW_BLOCK = 1440 * 20; // 20 days worth of blocks
...
static const uint256 hashGenesisBlock("0x00000dc630af1f2ef0d5b85bd2c95e6897fd8dc36f38ce24c5400a23043fe9a0");
static const uint256 hashGenesisBlockTestNet("0x00000d4d0549912423730a89e05b8f096591d32795b1612a0abd5c3541904ddf");
inline int64_t PastDrift(int64_t nTime)   { return nTime - ((1 * 4)+1) * 60; } // Allowable drift from the past
inline int64_t FutureDrift(int64_t nTime) { return nTime + 1 * 60; } // Allowable drift from the future
